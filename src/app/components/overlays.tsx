      ...
      {modal.open && (
        ...
        >
          <motion.div
            ...
            style={{ background: 'var(--aw-bg-modal)' }}
...
export function CallOverlay() {
  ...
  return (
    <div className="fixed inset-0 z-[300] flex flex-col items-center justify-center" style={{ background: 'rgba(0,0,0,0.85)' }}>
...
export function UnifiedCallModal() {
  ...
  return (
    ...
    >
      <div className="w-full max-w-[480px] md:max-w-[600px] max-h-[90vh] overflow-hidden rounded-t-[20px] md:rounded-[20px] md:mb-5 flex flex-col" style={{ background: 'var(--aw-bg-modal)' }}>
        <div className="flex justify-between items-center px-5 py-4 border-b border-[var(--aw-border)]">
