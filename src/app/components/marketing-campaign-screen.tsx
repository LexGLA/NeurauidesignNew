  ...
  return (
    <div className="flex flex-col h-full relative">
      <div className="flex items-center justify-between px-4 pt-4 pb-1">
        <div><h2 className="text-[18px] text-[var(--aw-text-primary)] m-0" style={{ fontWeight: 800 }}><i className="fa-solid fa-bullhorn ml-2" style={{ color: MKT_BLUE }} />کمپین‌ها</h2><p className="text-[12px] text-[var(--aw-text-muted)] mt-1 m-0">مدیریت و تحلیل کمپین‌های بازاریابی</p></div>
          ...
          <AnimatePresence mode="wait">
            {view === 'list' ? (
              ...
              <motion.div key="analytics" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}>
                ...
                <div className="rounded-[14px] p-3.5 mb-3 border border-[var(--aw-border)]" style={{ background: 'var(--aw-bg-card)' }}>
                  <div className="text-[13px] text-[var(--aw-text-primary)] mb-3" style={{ fontWeight: 600 }}><i className="fa-solid fa-chart-pie ml-1.5 text-[#B83D9E]" /> توزیع کانال‌ها</div>
