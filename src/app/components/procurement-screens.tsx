    ...
    <div className="flex flex-col h-full">
      <div className="px-4 pt-4 pb-1">
        <h2 className="text-[18px] text-[var(--aw-text-primary)] m-0" style={{ fontWeight: 800 }}>
          <i className="fa-solid fa-file-circle-plus text-[#F97316] ml-2" />
          درخواست‌های خرید
        </h2>
        <p className="text-[12px] text-[var(--aw-text-muted)] mt-1 m-0">ثبت و پیگیری درخواست‌های تأمین واحدها</p>
      </div>
              ...
              return (
                <div key={req.id} className="p-3" style={cardStyle}>
                  ...
                  <div className="flex items-center justify-between mt-2 pt-2 border-t border-[var(--aw-border)]">
                    ...
                    {req.status === 'new' && (
                      <button className="text-[10px] px-3 py-1.5 rounded-lg border-none cursor-pointer text-white" style={{ background: 'linear-gradient(135deg, #F97316, #C2410C)' }}>
                        بررسی
                      </button>
                    )}
                    {req.status === 'approved' && (
                      <button className="text-[10px] px-3 py-1.5 rounded-lg border-none cursor-pointer text-white" style={{ background: 'linear-gradient(135deg, #10B981, #047857)' }}>
...
export function ProcOrdersScreen() {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-4 pt-4 pb-1">
        <h2 className="text-[18px] text-[var(--aw-text-primary)] m-0" style={{ fontWeight: 800 }}>
          <i className="fa-solid fa-truck-field text-[#F97316] ml-2" />
          سفارشات خرید
        </h2>
        <p className="text-[12px] text-[var(--aw-text-muted)] mt-1 m-0">پیگیری سفارشات از پیش‌فاکتور تا تأمین</p>
      </div>
...
export function ProcDeliveryScreen() {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-4 pt-4 pb-1">
        <h2 className="text-[18px] text-[var(--aw-text-primary)] m-0" style={{ fontWeight: 800 }}>
          <i className="fa-solid fa-dolly text-[#F97316] ml-2" />
          دریافت و تحویل
        </h2>
        <p className="text-[12px] text-[var(--aw-text-muted)] mt-1 m-0">پیگیری وضعیت تحویل سفارشات</p>
      </div>
...
export function ProcFinanceScreen() {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-4 pt-4 pb-1">
        <h2 className="text-[18px] text-[var(--aw-text-primary)] m-0" style={{ fontWeight: 800 }}>
          <i className="fa-solid fa-money-check-dollar text-[#F97316] ml-2" />
          مالی تأمین
        </h2>
        <p className="text-[12px] text-[var(--aw-text-muted)] mt-1 m-0">مدیریت پرداخت‌ها و بدهی به تأمین‌کنندگان</p>
      </div>
