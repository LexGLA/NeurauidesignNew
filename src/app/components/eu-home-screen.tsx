...
function SectionHeader({ title, onMore }: { title: string; onMore?: () => void }) {
  return (
    <div className="flex items-center justify-between mb-2">
      ...
      <span style={{ fontFamily: KAMAND, fontSize: 16, fontWeight: 500, color: '#565656' }}>
        {title}
      </span>
      ...
      <button
        ...
        onClick={onMore}
      >
        <span style={{ fontFamily: KAMAND, fontSize: 10, color: '#565656' }}>مشاهده بیشتر</span>
        <i className="fa-solid fa-chevron-left" style={{ fontSize: 8, color: '#565656' }} />
      </button>
    </div>
  );
}
...
function SimpleWalletContent() {
  return (
    <div className="flex flex-col gap-3">
      ...
      <button className="w-full py-3 rounded-xl border-none text-white text-[14px] cursor-pointer"
    ...
    <div className="flex-1 overflow-y-auto pb-4 aw-scroll">
      ...
      <div className="mx-4 mt-2">
        ...
        >
          ...
          <div className="flex-1 flex flex-col items-end" style={{ gap: 1 }}>
            <p style={{ fontFamily: KAMAND, fontSize: 11, color: '#565656', fontWeight: 500, margin: 0 }}>
              موجودی کیف پول
            </p>
            <p style={{ margin: 0, color: '#565656', lineHeight: 1.2 }}>
              <span style={{ fontFamily: KAMAND, fontSize: 20, fontWeight: 900 }}>{'۲,۴۵۰,۰۰۰ '}</span>
              <span style={{ fontFamily: KAMAND, fontSize: 11, fontWeight: 700, color: '#737373' }}>تومان</span>
            </p>
          </div>
          ...
          <button
            style={{
              ...
              background: 'rgba(255,255,255,0.2)', border: '0.25px solid rgba(255,255,255,1)',
              display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer',
            }}
            onClick={() => openModal('کیف پول', <SimpleWalletContent />)}
          >
            <i className="fa-solid fa-plus" style={{ fontSize: 16, color: '#404040' }} />
          </button>
        </div>
      </div>
      ...
      <div className="flex gap-2 px-4 mt-2">
        ...
        <div
          ...
          style={{ ...gc, backdropFilter: 'blur(20px)', height: 58, flex: 1, overflow: 'hidden', cursor: 'pointer' }}
        ...
        >
          ...
          {/* text + badge LEFT */}
          <div className="flex-1 flex flex-col items-end" style={{ gap: 1 }}>
            <p style={{ fontFamily: KAMAND, fontSize: 12, fontWeight: 800, color: '#565656', margin: 0 }}>
              ۳۰٪ تخفیف اولین سفارش
            </p>
            <p style={{ fontFamily: KAMAND, fontSize: 11, color: '#565656', margin: 0 }}>
              تا پایان هفته
            </p>
            <div style={{
        ...
        <div className="flex justify-between">
          {quickActions.map((item) => (
            ...
            >
              ...
              <span style={{ fontFamily: KAMAND, fontSize: 10, color: '#565656' }}>
                {item.label}
              </span>
            </button>
          ))}
      ...
      <div className="px-4 mt-3">
        ...
        {displayOrders.map((o) => (
          ...
          >
            ...
            <i
              className={o.icon}
              style={{ fontSize: 16, color: '#404040', flexShrink: 0, width: 20, textAlign: 'center' as const }}
            />

            {/* ORDER text */}
            <div className="flex-1 flex flex-col items-end" style={{ gap: 1 }}>
              <p style={{ fontFamily: KAMAND, fontSize: 14, fontWeight: 700, color: '#565656', margin: 0 }}>
                {o.title}
              </p>
              <p style={{ fontFamily: KAMAND, fontSize: 12, color: '#565656', margin: 0 }}>
                {o.subtitle}
              </p>
            </div>
            ...
            <div className="flex flex-col items-start flex-shrink-0" style={{ gap: 4 }}>
              <p style={{ fontFamily: KAMAND, fontSize: 14, fontWeight: 500, color: '#737373', margin: 0 }}>
                {o.price}
              </p>
              <div style={{
                background: o.statusBg, borderRadius: 2, fontSize: 9, color: '#565656',
      ...
      <div className="flex gap-2 px-4 mt-2">
        {[
          ...
          >
            <p style={{ fontFamily: KAMAND, fontSize: 16, fontWeight: 700, color: '#565656', margin: 0 }}>
              {s.value}
            </p>
            <p style={{ fontFamily: KAMAND, fontSize: 12, color: '#565656', margin: 0 }}>
              {s.label}
...
export function EuHomeScreen() {
  const { theme } = useApp();
  return theme === 'glass' ? <EuHomeScreenGlass /> : <EuHomeScreenDefault />;
}
